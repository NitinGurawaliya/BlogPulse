...
// .wrangler/tmp/bundle-L2oCTs/checked-fetch.js
...
// .wrangler/tmp/bundle-L2oCTs/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-L2oCTs/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function createBlog(c) {
  ...
  try {
    ...
    console.log("Error in creating blog ", error2);
