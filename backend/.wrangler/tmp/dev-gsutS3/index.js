...
// .wrangler/tmp/bundle-2TS1Gg/checked-fetch.js
...
// .wrangler/tmp/bundle-2TS1Gg/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-2TS1Gg/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post("/api/v1/user/signup", async (c) => {
  ...
  try {
    ...
    const jwt2 = await sign2({ id: userid }, c.env.JWT_SECRET);
    c.status(201);
