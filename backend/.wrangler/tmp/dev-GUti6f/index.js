...
// .wrangler/tmp/bundle-Uiz8uz/checked-fetch.js
...
// .wrangler/tmp/bundle-Uiz8uz/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-Uiz8uz/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function createBlog(c) {
  ...
  try {
    const tagNames = body.tags.map((tag) => tag.trim());
...
async function editBlog(c) {
  ...
  try {
    ...
    console.log("Error in editing blog:", error2);
...
// src/router/tag.routes.ts
init_checked_fetch();
init_modules_watch_stub();

// src/controller/tagController.ts
init_checked_fetch();
init_modules_watch_stub();
var import_edge3 = __toESM(require_edge3());
async function getTags(c) {
...
// src/router/likes.routes.ts
init_checked_fetch();
init_modules_watch_stub();

// src/controller/likesController.ts
init_checked_fetch();
init_modules_watch_stub();
var import_edge4 = __toESM(require_edge3());
async function likePost(c) {
